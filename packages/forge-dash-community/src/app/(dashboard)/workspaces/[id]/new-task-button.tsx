...
// Explicit, theme-agnostic styles — no HeroUI default-* tokens (those render
// fields as white-on-white). Mirrors the New Workspace dialog idiom so the two
// creation flows look and behave identically. Accent is brand orange #FF6B2B.
const ACCENT = '#FF6B2B';
const fieldBase =
